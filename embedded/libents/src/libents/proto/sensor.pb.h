...
typedef struct _SensorMeasurement {
    ...
    union _SensorMeasurement_value {
...
#define _SensorType_MAX SensorType_DEVICE_DOWNTIME
#define _SensorType_ARRAYSIZE ((SensorType)(SensorType_DEVICE_DOWNTIME+1))
