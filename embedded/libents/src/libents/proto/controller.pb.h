...
typedef enum _MicroSDCommand_Type {
    ...
    /* Append a plain text line to the log file on the microSD card */
    MicroSDCommand_Type_LOG = 2
} MicroSDCommand_Type;
...
#define _MicroSDCommand_Type_MAX MicroSDCommand_Type_LOG
#define _MicroSDCommand_Type_ARRAYSIZE ((MicroSDCommand_Type)(MicroSDCommand_Type_LOG+1))
...
#define MicroSDCommand_log_tag                   6
...
X(a, STATIC,   ONEOF,    STRING,   (data,log,data.log),   6)
