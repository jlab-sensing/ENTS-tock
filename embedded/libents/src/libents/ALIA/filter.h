...
// initictes a struct for calculating the std deviation over a rolling window of
// the past n values
typedef struct {
  size_t head;
  size_t count;
...
// pushes a new value to the rolling window stats (adds new value and removes
// oldst value)
