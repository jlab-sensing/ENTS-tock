...
#define RADIOLIB_LORAWAN_DEV_EUI 70, B3, D5, 7E, D0, 07, 74, 17
#endif
#ifndef RADIOLIB_LORAWAN_APP_KEY  // Replace with your App Key
#define RADIOLIB_LORAWAN_APP_KEY \
  02, B0, 7E, 01, 50, 16, 02, 80, AE, 0D, 20, A6, 0A, B0, F7, 01
#endif
#ifndef RADIOLIB_LORAWAN_NWK_KEY  // Put your Nwk Key here
#define RADIOLIB_LORAWAN_NWK_KEY \
  B8, 2D, 91, 3F, AF, B0, 99, EE, 2E, 3B, BE, 9B, 31, 96, C1, 09
#endif
...
// incorrectly formatted build a byte array first (can't pass a braced-init-list
// directly to the function)

// devEUI: if you want to provide 8 raw bytes, define RADIOLIB_LORAWAN_DEV_EUI
// as 8 comma-separated bytes. If RADIOLIB_LORAWAN_DEV_EUI is a single integer,
// keep the cast below.
/* Example for 8-byte DEV EUI:
   #define RADIOLIB_LORAWAN_DEV_EUI 01,02,03,04,05,06,07,08
   then use:
     static const uint8_t devEUI_bytes[8] =
   FORMAT32_KEY(RADIOLIB_LORAWAN_DEV_EUI); static const uint64_t devEUI =
   bytes_to_u64_be(devEUI_bytes);
*/
